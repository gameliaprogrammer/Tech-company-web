      ...
      <div id="works" className="block worksBlock">
        <div className="container-fluid">
          ...
          <Modal
            ...
            destroyOnClose = {true}
          >
            <iframe title="Woocommerce Tutorial" width="100%" height="350" src="https://www.youtube.com/embed/EwMarg2orPw&list=PLLBWNs6n7YMUihYEVNEUGB29t3Rfq6bTa&index=7"></iframe>
          </Modal>
        </div>
      </div>
    );
